...
code one_latitude_data_t cell_temp_data[TEMPERATURE_DATA_NUM] = {
    { 3740, 120 },    { 4650, 113 },    { 5820, 105 },   { 6730, 100 },   { 7810, 95 },     { 9100, 90 },
    { 10640, 85 },    { 12490, 80 },    { 14720, 75 },   { 17420, 70 },   { 20720, 65 },    { 24760, 60 },
    { 29730, 55 },    { 35880, 50 },    { 43540, 45 },   { 53120, 40 },   { 65190, 35 },    { 80480, 30 },
    { 100000, 25 },   { 125080, 20 },   { 157530, 15 },  { 199870, 10 },  { 255470, 5 },    { 329190, 0 },
    { 427750, -5 },   { 560720, -10 },  { 741830, -15 }, { 991020, -20 }, { 1337500, -25 }, { 1824600, -30 },
    { 2517410 - 35 }, { 3514950, -40 },
};
#endif
